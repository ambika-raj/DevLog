...
const AddProject = () => {
  ...
  //     await axios.post('https://devlog-eis1.onrender.comapi/projects', data, {
        ...
        <div style={{ maxWidth: '760px', margin: '0 auto', padding: '40px 24px' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '16px', marginBottom: '32px' }}>
            ...
            <div>
              ...
              <p style={{ color: '#475569', fontSize: '0.85rem' }}>Document your latest work</p>
            </div>
          </div>
            ...
            <div style={{
              ...
              <div>
                ...
                <input type="text" name="title" value={formData.title}
                  onChange={handleChange} placeholder="e.g. DevLog — Project Tracker"
              ...
              <div>
                ...
                <textarea name="description" value={formData.description}
                  onChange={handleChange} placeholder="What does this project do? What problem does it solve?"
                  required rows={4}
              ...
              <div>
                ...
                >
                  ...
                  <input
                    ...
                    onKeyDown={addTech}
                    placeholder={formData.techStack.length === 0 ? "Type and press Enter (e.g. React)" : ""}
                    style={{
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
                <div>
                  ...
                  <input type="text" name="githubLink" value={formData.githubLink}
                ...
                <div>
                  ...
                  <input type="text" name="liveLink" value={formData.liveLink}
                    onChange={handleChange} placeholder="https://your-project.vercel.app"
                    style={inputStyle}
                    onFocus={(e) => e.target.style.borderColor = '#00C9A7'}
                    onBlur={(e) => e.target.style.borderColor = 'rgba(255,255,255,0.08)'} />
                </div>
                  ...
                  {thumbnailPreview ? (
                    ...
                    <>
                      ...
                      <p style={{ color: '#475569', fontSize: '0.85rem', textAlign: 'center' }}>
                        ...
                        <span style={{ fontSize: '0.75rem', color: '#334155' }}>PNG, JPG, WEBP up to 5MB</span>
                      </p>
                    </>
                  )}
              ...
              <button type="submit" disabled={loading}
                ...
                onMouseEnter={(e) => { if (!loading) e.target.style.boxShadow = '0 0 36px rgba(0,201,167,0.45)' }}
                onMouseLeave={(e) => { if (!loading) e.target.style.boxShadow = '0 0 24px rgba(0,201,167,0.25)' }}
              >
